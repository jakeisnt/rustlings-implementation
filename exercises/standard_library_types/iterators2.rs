...
pub fn capitalize_words(input: Vec<&str>) -> String {
    input.iter().map(|msg| capitalize_first(msg)).collect()
}
...
mod tests {
    ...
    fn test_iterate_string_vec() {
        ...
        let capitalized_words: Vec<String> = words.iter().map(|msg| capitalize_first(msg)).collect();
